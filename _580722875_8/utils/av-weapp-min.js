...
!function(e, t) {
    "object" == ("undefined" == typeof exports ? "undefined" : i(exports)) && "object" == ("undefined" == typeof module ? "undefined" : i(module)) ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == ("undefined" == typeof exports ? "undefined" : i(exports)) ? exports.AV = t() : e.AV = t();
    ...
    return function(e) {
        ...
        (function(e, n) {
            ...
            !function() {
                ...
                var S = function(e, t) {
                    ...
                    return n ? e : void 0;
                }, j = Math.pow(2, 53) - 1, x = A("length"), N = function(e) {
                    var t = x(e);
                ...
                var k = function(e) {
                    var t = function(t, n, r, i) {
                        var o = !N(t) && g.keys(t), s = (o || t).length, a = e > 0 ? 0 : s - 1;
                ...
                g.reduce = g.foldl = g.inject = k(1), g.reduceRight = g.foldr = k(-1), g.find = g.detect = function(e, t, n) {
                    var r = (N(e) ? g.findIndex : g.findKey)(e, t, n);
                    ...
                    var r, o, s = -1 / 0, a = -1 / 0;
                    if (null == t || "number" == typeof t && "object" != i(e[0]) && null != e) for (var u = 0, c = (e = N(e) ? e : g.values(e)).length; u < c; u++) null != (r = e[u]) && r > s && (s = r); else t = O(t, n), 
                    ...
                    var r = N(e) ? g.clone(e) : g.values(e), i = x(r);
                ...
                g.toArray = function(e) {
                    return e ? g.isArray(e) ? f.call(e) : g.isString(e) ? e.match(I) : N(e) ? g.map(e, g.identity) : g.values(e) : [];
                }, g.size = function(e) {
                ...
                var P = function e(t, n, r, i) {
                    for (var o = (i = i || []).length, s = 0, a = x(t); s < a; s++) {
                        var u = t[s];
                        if (N(u) && (g.isArray(u) || g.isArguments(u))) if (n) for (var c = 0, l = u.length; c < l; ) i[o++] = u[c++]; else e(u, n, r, i), 
                ...
                g.flatten = function(e, t) {
                    ...
                    return t = P(t, !0, !0), g.filter(e, function(e) {
                        return !g.contains(t, e);
                    });
                }), g.unzip = function(e) {
                    for (var t = e && g.max(e, x).length || 0, n = Array(t), r = 0; r < t; r++) n[r] = g.pluck(e, r);
                    return n;
                ...
                var R = function(e) {
                    return function(t, n, r) {
                        n = O(n, r);
                        for (var i = x(t), o = e > 0 ? 0 : i - 1; o >= 0 && o < i; o += e) if (n(t[o], o, t)) return o;
                        return -1;
                    };
                };
                g.findIndex = R(1), g.findLastIndex = R(-1), g.sortedIndex = function(e, t, n, r) {
                    for (var i = (n = O(n, r, 1))(t), o = 0, s = x(e); o < s; ) {
                ...
                var L = function(e, t, n, r, i) {
                    ...
                    var o = E(e.prototype), s = e.apply(o, i);
                ...
                g.pick = S(function(e, t) {
                    ...
                    var n, r = t[0];
                    return g.isFunction(r) ? (r = g.negate(r), t.length > 1 && (n = t[1])) : (t = g.map(P(t, !1, !1), String), 
                    r = function(e, n) {
                ...
                J = function(e, t, n, r) {
                    ...
                    return ("function" === o || "object" === o || "object" == (void 0 === t ? "undefined" : i(t))) && Q(e, t, n, r);
                }, Q = function(e, t, n, r) {
                    ...
                    if (n.push(e), r.push(t), s) {
                        ...
                        for (;c--; ) if (!J(e[c], t[c], n, r)) return !1;
                    } else {
                        var h, f = g.keys(e);
                        if (c = f.length, g.keys(t).length !== c) return !1;
                        for (;c--; ) if (h = f[c], !C(t, h) || !J(e[h], t[h], n, r)) return !1;
                    }
                ...
                "function" != typeof /./ && "object" != ("undefined" == typeof Int8Array ? "undefined" : i(Int8Array)) && "function" != typeof V && (g.isFunction = function(e) {
                ...
                g.escape = G(K), g.unescape = G(H), g.result = function(e, t, n) {
                    g.isArray(t) || (t = [ t ]);
                    var r = t.length;
                ...
                g.mixin = function(e) {
                    ...
                    return g;
                }.apply(t, r)) && (n.exports = o);
            }();
        }).call(t, n(6), n(29)(e));
    }, function(e, t, n) {
        var r = (n(0), n(39).Promise);
        ...
        var r = n(0), i = n(54), o = n(0).extend, s = n(1), a = n(5), u = n(3), c = u.getSessionToken, l = u.ajax, h = function(e, t) {
            ...
            var t = e.service, n = void 0 === t ? "api" : t, r = e.version, i = void 0 === r ? "/wenda/" : r, o = e.path, s = a._config.serverURLs[n];
        ...
        e.exports = {
            ajax: function(e) {
                var t = e.method, n = e.url, i = e.query, o = e.data, f = e.headers, d = void 0 === f ? {} : f, p = e.onprogress, _ = e.timeout, v = h++;
                u("request(%d) %s %s %o %o %o", v, t, n, i, o, d);
                var y = {};
                if (i) for (var m in i) "object" === r(i[m]) ? y[m] = JSON.stringify(i[m]) : y[m] = i[m];
                return new l(function(e, r) {
                    var l = s(t, n).set(d).query(y).send(o);
                    p && l.on("progress", p), _ && l.timeout(_), l.end(function(s, l) {
                        return s ? (l && (a.enabled("leancloud:request") || c("request(%d) %s %s %o %o %o", v, t, n, i, o, d), 
                        c("response(%d) %d %O %o", v, l.status, l.body || l.text, l.header), s.statusCode = l.status, 
                        s.responseText = l.text, s.response = l.body), r(s)) : (u("response(%d) %d %O %o", v, l.status, l.body || l.text, l.header), 
                        e(l.body));
                    });
                });
            },
        ...
        (function(t) {
            var r = n(0), i = n(30), o = n(3), s = o.inherits, a = o.parseDate, u = t.AV || {};
            u._config = {
                serverURLs: {},
                useMasterKey: !1,
                production: null,
            ...
            u._installationId = null, u._getInstallationId = function() {
                ...
                if ("File" === e.__type) {
                    var l = new u.File(e.name), h = r.clone(e);
        ...
        try {
            ...
            "object" == (void 0 === o ? "undefined" : i(o)) && (n = o);
        }
        e.exports = n;
    }, function(e, n, r) {
        function s() {
        ...
        var _;
        void 0 !== o ? _ = o : "undefined" != typeof self ? _ = self : (console.warn("Using browser-only version of superagent in non-browser environment"), 
        _ = this);
        var v = r(32), y = r(33), m = r(18), g = r(34), b = r(36), w = n = t.exports = function(e, t) {
        ...
        w.serializeObject = a, w.parseString = c, w.types = {
            ...
            return 1 === arguments.length && (t = ""), "object" == (void 0 === t ? "undefined" : i(t)) && null !== t && (n = t, 
            t = ""), n || (n = {
            ...
            return e && "object" == (void 0 === e ? "undefined" : i(e)) && !Array.isArray(e) && "[object Object]" !== Object.prototype.toString.call(e);
        ...
        var r = n(10), s = n(26), a = n(27), u = r.LISTENERS, c = r.CAPTURE, l = r.BUBBLE, h = r.ATTRIBUTE, f = r.newNode, d = s.defineCustomEventTarget, p = a.createEventWrapper, _ = a.STOP_IMMEDIATE_PROPAGATION_FLAG, v = void 0 !== o && void 0 !== o.EventTarget, y = e.exports = function e() {
        ...
        y.prototype = Object.create((v ? o.EventTarget : Object).prototype, {
            constructor: {
                value: y,
                writable: !0,
                configurable: !0
            ...
            addEventListener: {
                value: function(e, t, n) {
                    if (null == t) return !1;
                    if ("function" != typeof t && "object" != (void 0 === t ? "undefined" : i(t))) throw new TypeError('"listener" is not an object.');
                    var r = n ? c : l, o = this[u][e];
                    if (null == o) return this[u][e] = f(t, r), !0;
                    for (var s = null; null != o; ) {
                        if (o.listener === t && o.kind === r) return !1;
                        s = o, o = o.next;
                    }
                    return s.next = f(t, r), !0;
                },
                configurable: !0,
                writable: !0
            },
        ...
        var u = function() {
        ...
        }(), c = n(14), l = n(9), h = 0, f = 1, d = 3, p = [ "open", "error", "message", "close" ], _ = void 0, v = function(e) {
            function t(e, n) {
                ...
                return i._url = e, i._protocal = n || "", i._readyState = h, _ && _.dispatchEvent({
                    type: "close"
                }), _ = i, wx.onSocketOpen(function(e) {
            ...
            return s(t, l(p)), u(t, [ {
                key: "close",
                value: function() {
                    this.readyState !== d && (this.readyState === h && console.warn("close WebSocket which is connecting might not work"), 
                    wx.closeSocket());
                }
            }, {
                key: "send",
        ...
        var r = n(0), i = n(1), o = n(41), s = [ "getItem", "setItem", "removeItem", "clear" ];
        ...
        var r = n(19), i = n(5), o = t.removeAsync = r.removeItemAsync.bind(r), s = function(e, t) {
            try {
                e = JSON.parse(e);
            } catch (e) {
                return null;
        ...
        i.Error = n(4), n(43), n(45)(i), n(46)(i), n(47)(i), n(48)(i), n(49)(i), n(50)(i), 
        n(58)(i), n(59)(i), n(60)(i), n(61)(i), n(62)(i), n(64)(i), n(65)(i), n(66)(i), 
        n(67)(i), n(68)(i), n(69)(i), i.Conversation = n(70), n(71), e.exports = i;
    }, function(e, t, n) {
        n(24);
    }, function(r, i, s) {
        var a = s(25).polyfill;
        ...
        (function(t) {
            var r = "function" == typeof Symbol && "symbol" == i(Symbol.iterator) ? function(e) {
                ...
                return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : void 0 === e ? "undefined" : i(e);
            }, s = n(12), a = n(13), u = n(11), c = n(15), l = n(28), h = n(16);
            e.exports = {
                polyfill: function() {
        ...
        function o(e, t, n) {
            "function" != typeof n && "object" != (void 0 === n ? "undefined" : i(n)) && (n = null);
            for (var r = null, o = e[a][t]; null != o; ) o.kind === u ? null == r ? e[a][t] = o.next : r.next = o.next : r = o, 
            o = o.next;
        ...
        t.defineCustomEventTarget = function(e, t) {
            ...
            }), n.prototype = Object.create(e.prototype, i), n;
        };
    }, function(e, t, n) {
        ...
        var r = n(17), i = [ "Weapp" ].concat(n(31));
        ...
        e.exports = r, r.prototype.clearTimeout = function() {
            ...
            if (!e || "object" != (void 0 === e ? "undefined" : i(e))) return this._timeout = e, 
        ...
        (t = e.exports = i.debug = i.default = i).coerce = function(e) {
            ...
            return !1;
        }, t.humanize = n(38), t.instances = [], t.names = [], t.skips = [], t.formatters = {};
    }, function(e, t) {
        function n(e) {
        ...
        var a = 1e3, u = 60 * a, c = 60 * u, l = 24 * c, h = 365.25 * l;
        e.exports = function(e, t) {
            t = t || {};
            var s = void 0 === e ? "undefined" : i(e);
            if ("string" === s && e.length > 0) return n(e);
            if ("number" === s && !1 === isNaN(e)) return t.long ? o(e) : r(e);
        ...
        (function(t) {
            !function(t, n) {
                ...
                function u() {
                    for (var e = 0; e < R; e += 2) (0, Q[e])(Q[e + 1]), Q[e] = void 0, Q[e + 1] = void 0;
                    R = 0;
                }
                function c(e, t) {
                ...
                function l(e) {
                    var t = this;
                    if (e && "object" == (void 0 === e ? "undefined" : i(e)) && e.constructor === t) return e;
                    var n = new t(h);
                    return g(n, e), n;
                }
                function h() {}
                ...
                function y(e, t) {
                    t._state === G ? w(e, t._result) : t._state === z ? O(e, t._result) : S(t, void 0, function(t) {
                        return g(e, t);
                    }, function(t) {
                        return O(e, t);
                    });
                ...
                function m(e, t, n) {
                    ...
                    $.error = null) : void 0 === n ? w(e, t) : r(n) ? v(e, t, n) : w(e, t);
                }
                function g(t, n) {
                ...
                function w(e, t) {
                    e._state === H && (e._result = t, e._state = G, 0 !== e._subscribers.length && F(E, e));
                }
                function O(e, t) {
                    e._state === H && (e._state = z, e._result = t, F(b, e));
                }
                function S(e, t, n, r) {
                    var i = e._subscribers, o = i.length;
                    e._onerror = null, i[o] = t, i[o + G] = n, i[o + z] = r, 0 === o && e._state && F(E, e);
                }
                function E(e) {
                ...
                function C(e, t, n, i) {
                    ...
                    if (o) {
                        if ((s = A(n, i)) === $ ? (c = !0, a = s.error, s.error = null) : u = !0, t === s) return void O(t, d());
                    } else s = i, u = !0;
                    t._state !== H || (o && u ? g(t, s) : c ? O(t, a) : e === G ? w(t, s) : e === z && O(t, s));
                }
                function T(e, t) {
                    try {
                        t(function(t) {
                ...
                var I = void 0, P = I = Array.isArray ? Array.isArray : function(e) {
                    return "[object Array]" === Object.prototype.toString.call(e);
                }, R = 0, D = void 0, L = void 0, F = function(e, t) {
                    Q[R] = e, Q[R + 1] = t, 2 === (R += 2) && (L ? L(u) : V());
                }, q = void 0 !== o ? o : void 0, M = q || {}, B = M.MutationObserver || M.WebKitMutationObserver, W = "undefined" == typeof self && "undefined" != typeof process && "[object process]" === {}.toString.call(process), J = "undefined" != typeof Uint8ClampedArray && "undefined" != typeof importScripts && "undefined" != typeof MessageChannel, Q = new Array(1e3), V = void 0;
                V = W ? function() {
                ...
                var K = Math.random().toString(36).substring(2), H = void 0, G = 1, z = 2, $ = {
                    error: null
                }, X = 0, Y = function() {
                    function e(e, t) {
                        this._instanceConstructor = e, this.promise = new e(h), this.promise[K] || x(this.promise), 
                        P(t) ? (this.length = t.length, this._remaining = t.length, this._result = new Array(this.length), 
                        0 === this.length ? w(this.promise, this._result) : (this.length = this.length || 0, 
                        this._enumerate(t), 0 === this._remaining && w(this.promise, this._result))) : O(this.promise, N());
                    }
                    return e.prototype._enumerate = function(e) {
                        ...
                        if (r === l) {
                            var i = p(e);
                            if (i === c && e._state !== H) this._settledAt(e._state, t, e._result); else if ("function" != typeof i) this._remaining--, 
                        ...
                        var r = this.promise;
                        r._state === H && (this._remaining--, e === z ? O(r, n) : this._result[t] = n), 
        ...
        function r(e, t) {
            if ("us" === t) return l("https://wx3.xxjr.com");
            switch (e.slice(-9)) {
              case "-9Nh9j0Va":
                return e.slice(0, 8).toLowerCase(), {
                    push: "https://wx3.xxjr.com",
                    stats: "https://wx3.xxjr.com",
                    engine: "https://wx3.xxjr.com",
                    api: "https://wx3.xxjr.com"
                };

              case "-MdYXbMMI":
                return l("https://wx3.xxjr.com");
        ...
        var i = n(5), o = n(44), s = n(3).isNullOrUndefined, a = n(0), u = a.extend, c = a.isObject, l = function(e) {
            return {
                push: e,
                stats: e,
                engine: e,
        ...
        i.init = function(e) {
            ...
            var t = e.appId, n = e.appKey, s = e.masterKey, a = (e.hookKey, e.region), f = void 0 === a ? "cn" : a, d = e.serverURLs, p = e.disableCurrentUser, _ = e.production, v = e.realtime;
            ...
            i._config.applicationKey = n, i._config.masterKey = s, void 0 !== _ && (i._config.production = _), 
            void 0 !== p && (i._config.disableCurrentUser = p), i._appRouter = new o(i);
            var y = h || void 0 !== d || "cn" !== f;
            i._setServerURLs(u({}, r(t, f), i._config.serverURLs, "string" == typeof d ? l(d) : d), y), 
        ...
        r.prototype.disable = function() {
            ...
            if (!(this.disabled || Date.now() < this.lockedUntil)) return this.lock(10), i({
                method: "get",
                url: "https://wx3.xxjr.com/wenda/route",
                query: {
        ...
        var r = n(0), i = n(51), o = n(52), s = n(53), a = n(4), u = n(2)._request, c = n(1), l = n(3), h = l.tap, f = l.transformFetchOptions, d = n(7)("leancloud:file"), p = n(57);
        e.exports = function(e) {
            var t = function() {
                return Math.floor(65536 * (1 + Math.random())).toString(16).substring(1);
            }, n = function(e) {
        ...
        !function() {
            var t = n(55), r = n(21).utf8, i = n(56), o = n(21).bin, s = function e(n, s) {
        ...
        }(), o = n(0), s = n(4), a = n(2)._request, u = n(3), c = u.isNullOrUndefined, l = u.ensureArray, h = u.transformFetchOptions, f = u.setValue, d = u.findValue, p = u.isPlainObject, _ = function e(t) {
            return o.isArray(t) ? t.map(e) : p(t) ? o.mapObject(t, e) : o.isObject(t) && t._toPointer ? t._toPointer() : t;
        }, v = [ "objectId", "createdAt", "updatedAt" ], y = function(e) {
            if (-1 !== v.indexOf(e)) throw new Error("key[" + e + "] is reserved");
        }, m = function(e) {
            ...
            e.Object = function(t, n) {
                ...
                _applyOpSet: function(t, n) {
                    ...
                    e._objectEach(t, function(t, o) {
                        ...
                        f(n, o, t._estimate(u, r, o)), c && c[l] === e.Op._UNSET && delete c[l];
                    });
                },
                ...
                _rebuildEstimatedDataForKey: function(t) {
                    ...
                    e._arrayEach(this._opSetQueue, function(r) {
                        var o = r[t];
                        if (o) {
                            var s = d(n.attributes, t), a = i(s, 4), u = a[0], c = a[1], l = a[2], h = a[3];
                            f(n.attributes, t, o._estimate(u, n, t)), c && c[l] === e.Op._UNSET && delete c[l], 
                ...
                fetch: function() {
                    ...
                    return a("classes", this.className, this.id, "GET", h(e), t).then(function(t) {
                        var r = n.parse(t);
                ...
                save: function(t, n, r) {
                    ...
                    var h = this, f = [], d = [];
                    return e.Object._findUnsavedChildren(h, f, d), f.length + d.length > 1 ? e.Object._deepSaveAsync(this, h, u) : (this._startSave(), 
                    ...
                    this._allPreviousSaves = this._allPreviousSaves.catch(function(e) {}).then(function() {
                        var e = h.id ? "PUT" : "POST", t = h._getSaveJSON(), n = {};
                        if ((h._fetchWhenSave || u.fetchWhenSave) && (n.new = "true"), u._failOnNotExist && (n.failOnNotExist = "true"), 
                        u.query) {
                            var r;
                        ...
                        o.extend(t, h._flags);
                        var c = "classes", f = h.className;
                        "_User" !== h.className || h.id || (c = "users", f = null);
                        var d = (u._makeRequest || a)(c, f, h.id, e, t, u, n);
                        return d = d.then(function(e) {
                            var t = h.parse(e);
                            return u.wait && (t = o.extend(i || {}, t)), h._finishSave(t), u.wait && h.set(s, l), 
                            h;
                        }, function(e) {
                ...
                return c.then(function() {
                    return e.Promise._continueWhile(function() {
                        ...
                        }), h = n, 0 === t.length) return e.Promise.reject(new s(s.OTHER_CAUSE, "Tried to save a batch with a cycle."));
                        var i = e.Promise.resolve(o.map(t, function(t) {
                            ...
                            return a("batch", null, null, "POST", {
                                requests: o.map(t, function(e) {
                                    ...
                                    o.extend(n, e._flags), r = "/wenda/" + e.className, "_User" !== e.className || e.id || (r = "/users");
                                    var r = r;
        ...
        e.exports = function(e) {
            e.User = e.Object.extend("_User", {
                ...
                logOut: function() {
                    return e._config.disableCurrentUser ? (console.warn("AV.User.current() was disabled in multi-user environment, call logOut()"), 
                ...
                currentAsync: function() {
                    return e._config.disableCurrentUser ? (console.warn("AV.User.currentAsync() was disabled in multi-user environment"), 
                ...
                current: function() {
                    if (e._config.disableCurrentUser) return console.warn("AV.User.current() was disabled in multi-user environment"), 
                    null;
        ...
        e.exports = function(e) {
            e.Query = function(t) {
                ...
                _createRequest: function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.toJSON(), t = arguments[1], n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : this.className;
        ...
        var r = n(0), i = n(63), o = n(1), s = n(3).inherits, a = n(2).request, u = function(e, t) {
            return a({
                method: "POST",
        ...
        e.exports = function(e) {
            e.LiveQuery = s(i, {
                ...
                init: function(t) {
                    ...
                    if (!e._config.realtime) throw new Error("LiveQuery not supported. Please use the LiveQuery bundle");
        ...
        e.exports = function(e) {
            ...
            e.Status = function(e, t) {
                return this.data = {}, this.inboxType = "default", this.query = null, e && "object" === (void 0 === e ? "undefined" : r(e)) ? this.data = e : (e && (this.data.image = e), 
