...
a.Drawing = function() {
    ...
    function e(t) {
        return (t = t && t.split(" ")[0]) && t[0] === w && t.substring(1);
    }
    function o() {
        if (m.length > 0) {
            if (v >= m.length) {
                if (!x) return void (v = m.length - 1);
                v = 0;
            }
        ...
        switch (console.log("nextAction action:" + o + " value:" + l), o) {
          case "countdown":
            i.isEmpty(l) && (l = 3), a.ShapeBuilder.letter(l, function(t) {
                I || i.isEmpty(l) && 0 == t.dots.length || l.length > 0 && t.dots.length > 0 && u != n && !I && t.dots.length != h() || u == n && (t.dots.length == h() || 0 == h()) ? (!I && S ? p.unshift(n) : (C = 0, 
                m.push(t), u = n, null != (l = parseInt(l)) && l > 1 && p.unshift("#countdown " + (l - 1)), 
                u = n), S = !1, setTimeout(s, b)) : (console.error("2:remake shape:[" + n + "] lastCmd:[" + u + "] makeTime:" + C), 
                C > 10 ? r() : (p.unshift(n), setTimeout(s, b)));
            });
            break;
          ...
          default:
            ...
            a.ShapeBuilder.letter(f, function(t) {
                I || i.isEmpty(f) && 0 == t.dots.length || f.length > 0 && t.dots.length > 0 && u != n && t.dots.length != h() || u == n && (t.dots.length == h() || 0 == h()) ? (!I && S ? p.unshift(n) : (u = n, 
                C = 0, m.push(t)), S = !1, setTimeout(s, b)) : (console.error("1:remake shape:[" + n + "] lastCmd:[" + u + "] makeTime:" + C), 
                C > 10 ? r() : (p.unshift(n), setTimeout(s, b)));
            });
        }
        return !0;
    ...
    function r() {
        v = 0, p.splice(0, p.length), m.splice(0, m.length), M = !1, S = !0, C = 0, c = "", 
        d && d(!1, c);
    }
    function l(t) {
        return p = "object" === (void 0 === t ? "undefined" : n(t)) ? t : t.split("|"), 
        v = 0, m.splice(0, m.length), M = !0, S = !0, C = 0, a.Shape.clearDots(), setTimeout(function() {
            p.length > 0 && r();
        }, 3e3 + 500 * p.length), s(), !0;
    }
    var c, u, f, d, g, p = [], m = [], v = 0, y = [], w = "#", x = !0, M = !1, S = !1, C = 0, b = 50, I = !1, P = function(t) {
        setTimeout(t, 50);
    };
    return {
        init: function(t, n) {
            f = t.getCanvasContext(), b = (I = n) ? 0 : 50;
        },
        simulate: function(t, n) {
            return console.log("simulate action:" + t + " cyclePlay:" + x), x = n, c == t ? 0 == p.length ? (v = 0, 
            d && d(!0, c), this.startRenderData(), 1) : (console.log("simulate last cmd data not create complite"), 
            2) : (c = t, l(t), 0);
        },
        loop: function(t) {
            g = g || t, M || (g(), f.draw(), P.call(this, this.loop.bind(this)));
        },
        draw: function() {
            f.draw();
        },
    ...
    return {
        ...
        letter: function(o, a) {
            console.log("builder shape letter:[" + o + "]"), t();
            var s = l, c = r;
    ...
    return {
        ...
        switchShape: function(l, c) {
            ...
            if (l.dots.length > n.length) {
                for (u = l.dots.length - n.length + 50, v = 1; v <= u; v++) {
            ...
            for (var w = l.dots; w.length > 0; ) y = Math.floor(Math.random() * w.length), n[v].e = c ? .6 : (n[v].s, 
            .5), n[v].s ? n[v].move(new a.Point({
                ...
                z: 5 * Math.random() + 2,
                h: 0
            })), n[v].moveComplite = !1, w = w.slice(0, y).concat(w.slice(y + 1)), v++;
            for (y = v; y < n.length; y++) n[y].s && (n[y].move(new a.Point({
                z: 5 * Math.random() + 5,
                a: Math.random(),
                h: 2
            })), n[y].s = !1, n[y].e = .08, n[y].move(new a.Point({
                x: Math.random() * f.w,
                y: Math.random() * f.h,
                a: .3,
                z: 3 * Math.random(),
