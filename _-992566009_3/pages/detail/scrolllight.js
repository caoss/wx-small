...
Page({
    data: {
        ...
        light: [ "ffffff", "b1b1b1", "010101", "fe3f35", "f7b142", "fbee48", "a9ee3b", "58ea3f", "69fca3", "46b0fe", "3f37fe", "8f2dfc", "e525ae", "fd2b84", "f89997" ],
        speed: [ {
            name: "慢",
            time: "15s"
        }, {
    ...
    cgOption: function(t) {
        ...
        }) : "light" == t.currentTarget.dataset.type ? this.setData({
            "select.obj.light": t.currentTarget.dataset.index
